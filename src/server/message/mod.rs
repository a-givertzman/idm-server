...
//! 
//! - Переполнение Size (очень большой payload)
//! 
//! - Несколько сообщений в одном буфере подряд
//! 
//! - Повреждённый SYN внутри уже начатого разбора
//! 
//! - Проверка устойчивости к мусорным данным перед SYN
//! 
//! - Стресс-тест длинных сообщений (> размер TCP-буфера)
//! 
//! - Тест уровня Connection (end-to-end через read loop)
//! 
mod cot;
mod field_id;
mod field;
